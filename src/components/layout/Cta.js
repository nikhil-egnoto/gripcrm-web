...
export default function Cta({ className, title, title2, description }) {
    return (
        <div className={`container mx-auto relative bg-white rounded-2xl lg:pt-0 pt-10 lg:overflow-visible overflow-hidden ${className}`}>
